...
class AttachVolumeTestJSON(base.BaseV2ComputeTest):
    ...
    def _create_and_attach(self):
        ...
        _, body = self.servers_client.attach_volume(self.server['id'],
                                                    self.volume['id'],
                                                    device='/dev/%s' % self.device)
        self.attachment = body['volumeAttachment']
    ...
    def test_list_get_volume(self):
        ...
        self.assertIn(self.attachment['id'], map(lambda x: x['id'], attachments))
        ...
        self.assertEqual(self.attachment['id'], attachment['id'])
